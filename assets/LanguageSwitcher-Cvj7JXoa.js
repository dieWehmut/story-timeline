import{o as p,u as h,j as t}from"./index-QP3o7TpY.js";import{a as r,z as x}from"./vendor-ui-BmwYIqOs.js";function v({className:l=""}){const{language:i,setLanguage:c}=p(),{t:e}=h(),[n,s]=r.useState(!1),o=r.useRef(null),d=[{code:"zh-CN",name:e("languages.zh-CN")},{code:"zh-TW",name:e("languages.zh-TW")},{code:"en",name:e("languages.en")},{code:"ja",name:e("languages.ja")},{code:"de",name:e("languages.de")},{code:"fr",name:e("languages.fr")},{code:"es",name:e("languages.es")},{code:"la",name:e("languages.la")}];r.useEffect(()=>{const a=u=>{o.current&&!o.current.contains(u.target)&&s(!1)};if(n)return document.addEventListener("mousedown",a),()=>document.removeEventListener("mousedown",a)},[n]);const m=a=>{c(a),s(!1)},g=()=>{s(!n)};return t.jsxs(t.Fragment,{children:[t.jsx("style",{dangerouslySetInnerHTML:{__html:`
          .language-dropdown {
            opacity: 0;
